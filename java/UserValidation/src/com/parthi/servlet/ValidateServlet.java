...
public class ValidateServlet extends HttpServlet
{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		{
		  requestDispatcher = request.getRequestDispatcher("/UserValidation/AdminServlet");	
		}
		else if(userType.equals("User"))
		{
			requestDispatcher = request.getRequestDispatcher("/UserValidation/UserServlet");	
		}
		else
		{
			requestDispatcher = request.getRequestDispatcher("/UserValidation/invalid");	
		}
